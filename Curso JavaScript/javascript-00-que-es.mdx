...
![pastel web](/images/javascript/00-que-es/00-pastel-web.png)
...
Pero para poder entender javaScript, antes debemos aprendernos ciertos conceptos, que veremos a continuación:

* [Fundamentos](/js-fundamentos-00-conceptos-previos.md)
* [Variables](/js-fundamentos-01-variables.md)
* [Tipos de datos](/js-fundamentos-02-tipos-de-datos.md)
</article>
